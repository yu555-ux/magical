        ...
        <AnimatePresence>
          {open && (
            <motion.div
              ...
              className="absolute right-0 top-[calc(100%+8px)] w-[calc(100vw-2rem)] max-w-[340px] max-h-[55vh] md:max-h-[60vh] flex flex-col overflow-hidden glass-panel border-glow"
            >
              {/* ═══ Header ═══ */}
