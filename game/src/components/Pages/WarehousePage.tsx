      ...
      <AnimatePresence>
        {realizeTarget && realizePreview && (
          <motion.div
            ...
            className="fixed inset-0 bottom-[calc(3.5rem+env(safe-area-inset-bottom,0px))] md:bottom-0 z-[130] flex items-center justify-center bg-aether-dark/90 backdrop-blur-md"
