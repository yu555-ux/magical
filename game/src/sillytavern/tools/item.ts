...
add_item: {
  ...
  category: 'variable',
  description:
    '向主角或 NPC 的持有物品或仓库中添加物品。自动创建完整的物品条目（等级/描述/效果/数量）。\n\n' +
    '【必须调用的场景】\n' +
    '- 购买/获赠/拾取/交易/奖励获得任何物品\n' +
    '- NPC 获得新物品或已有物品数量增加\n' +
    '- 从仓库取出物品到身上\n\n' +
    '【严禁的行为】\n' +
    '- 在叙事中说"你获得了XX""他递给你XX"但不调用此工具\n' +
    '- 即兴编造物品的等级/效果——先查世界书确认该物品是否存在\n' +
    '- reason 写成标签（"获得"）而非来源描述\n\n' +
    '【你的职责】\n' +
    '你不是物品的创造者，你是物品流动的记录者。\n' +
    'reason 必须描述物品从哪里来、为什么获得。\n' +
    '✅ "从柳三娘处以300G购买"  ❌ "获得"\n\n' +
    '【物品分类】\n' +
    '- 灵宝: 超凡宝物，有等级/描述/效果\n' +
...
remove_item: {
  ...
  description:
    ...
    '- 物品转移到仓库\n\n' +
    '【严禁的行为】\n' +
    '- 在叙事中描述"你喝掉了最后一瓶治疗药剂"但不调用此工具\n' +
    '- 移除不存在的物品——先用 get_status 确认持有\n' +
    '- reason 写成标签（"使用""丢弃"）而非使用场景\n\n' +
    '【你的职责】\n' +
    '你不是物品的销毁者，你是物品消耗的记录者。\n' +
    'reason 必须描述在什么情况下、为什么消耗了该物品。\n' +
    '✅ "战斗中饮用以恢复体力"  ❌ "使用"\n\n' +
    '【moveTo 选项】\n' +
    '- "仓库": 转移到仓库（如卸下装备）\n' +
    '- 不填: 彻底删除（消耗品/丢弃）',
